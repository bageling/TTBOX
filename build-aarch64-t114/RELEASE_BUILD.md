...
| 字段 | 值 |
|---|---|
| `commit` | `f02579c02c4b2e0178c6113c72178df17d19b296` |
...
| `build_time_utc` | 2026-09-20T06:31:34Z |
...
| `md5` | `c64c929e27ff600eaa552bda1ac5536a` |
| `sha256` | `80e975347efbf44f00ab7bf576f211bf2f48fe020862db504323096aa2a741e5` |
| `size` | 1065048 B |
| `buildid` | `6e9fd5aa993e3bf41f810a5d0bfe8915d54c5468` |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（cc5256b… → f02579c…） ⇒ 本次 md5=c64c929e27ff600eaa552bda1ac5536a 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
f02579c02c4b2e0178c6113c72178df17d19b296 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /mnt/c/Users/Administrator/WorkBuddy/2026-09-15-15-04-22/sysroot-aarch64 | /mnt/c/ttbox-local/build-aarch64-t114/ttbox_core_main | md5=c64c929e27ff600eaa552bda1ac5536a | BuildID=6e9fd5aa993e3bf41f810a5d0bfe8915d54c5468 | 2026-09-20T06:31:34Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=f02579c02c4b2e0178c6113c72178df17d19b296 md5=c64c929e27ff600eaa552bda1ac5536a sha256=80e975347efbf44f00ab7bf576f211bf2f48fe020862db504323096aa2a741e5 buildid=6e9fd5aa993e3bf41f810a5d0bfe8915d54c5468 vector_hash=0091a7df2bbf4d427e34bfd5594ff5ca56ca1398c05beb260d1db37c06cb63eb -->
