...
| 字段 | 值 |
|---|---|
| `commit` | `b9c923ea627a5b2bb2caa0aec4188f0f26550ce8` |
...
| `build_time_utc` | 2026-09-20T07:29:20Z |
...
| `md5` | `f4379e65e6e78fde5bd92714fc71a519` |
| `sha256` | `8017052c21e25116dcb70962b7d2f4998d9f911ee9796528e3099bfee636f02a` |
| `size` | 1073264 B |
| `buildid` | `8d100d46a2b7c8ec36179f848a011c7d214b841a` |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（803f6da… → b9c923e…） ⇒ 本次 md5=f4379e65e6e78fde5bd92714fc71a519 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
b9c923ea627a5b2bb2caa0aec4188f0f26550ce8 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /mnt/c/Users/Administrator/WorkBuddy/2026-09-15-15-04-22/sysroot-aarch64 | /mnt/c/ttbox-local/build-aarch64-t114/ttbox_core_main | md5=f4379e65e6e78fde5bd92714fc71a519 | BuildID=8d100d46a2b7c8ec36179f848a011c7d214b841a | 2026-09-20T07:29:20Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=b9c923ea627a5b2bb2caa0aec4188f0f26550ce8 md5=f4379e65e6e78fde5bd92714fc71a519 sha256=8017052c21e25116dcb70962b7d2f4998d9f911ee9796528e3099bfee636f02a buildid=8d100d46a2b7c8ec36179f848a011c7d214b841a vector_hash=0091a7df2bbf4d427e34bfd5594ff5ca56ca1398c05beb260d1db37c06cb63eb -->
