...
| 字段 | 值 |
|---|---|
| `commit` | `70d07f76d329a0b7f7929086d09c181d1f1cf169` |
...
| `build_time_utc` | 2026-09-17T15:16:20Z |
...
| `md5` | `ca7b58dd46f4251d36c1bdb504312bfd` |
| `sha256` | `3f760bc1c5e939feb98e148e0f9414ec6df073a9c25abe5af67468b872ffceb0` |
| `size` | 1055640 B |
| `buildid` | `6dc3bf994cd98a92d44f38ef7c2f075faf64053b` |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（dc5670c… → 70d07f7…） ⇒ 本次 md5=ca7b58dd46f4251d36c1bdb504312bfd 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
70d07f76d329a0b7f7929086d09c181d1f1cf169 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /mnt/c/Users/Administrator/WorkBuddy/2026-09-15-15-04-22/sysroot-aarch64 | /mnt/c/Users/Administrator/Desktop/TTBOX-Module-Edition-main/build-aarch64-t114/ttbox_core_main | md5=ca7b58dd46f4251d36c1bdb504312bfd | BuildID=6dc3bf994cd98a92d44f38ef7c2f075faf64053b | 2026-09-17T15:16:20Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=70d07f76d329a0b7f7929086d09c181d1f1cf169 md5=ca7b58dd46f4251d36c1bdb504312bfd sha256=3f760bc1c5e939feb98e148e0f9414ec6df073a9c25abe5af67468b872ffceb0 buildid=6dc3bf994cd98a92d44f38ef7c2f075faf64053b vector_hash=0505ccefc7315ac4df2f59b9c1c4f8b29a7127f9f469f8ddcafea29a9d016994 -->
