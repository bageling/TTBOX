...
| 字段 | 值 |
|---|---|
| `commit` | `45870f6b91a74364dca5825d7678e5524a08c3c7` |
...
| `build_time_utc` | 2026-09-19T07:32:40Z |
...
| `md5` | `4e2d1bc9a1c65fade6e048b31bf9db08` |
| `sha256` | `9343b6e308a8137277456ba66111e444119225b5b21c17a44db196fc84bb1875` |
| `size` | 1051520 B |
| `buildid` | `d69c7b15c467ab014a52434db39ce3195aaab883` |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（e0474b1… → 45870f6…） ⇒ 本次 md5=4e2d1bc9a1c65fade6e048b31bf9db08 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
45870f6b91a74364dca5825d7678e5524a08c3c7 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /mnt/c/Users/Administrator/WorkBuddy/2026-09-15-15-04-22/sysroot-aarch64 | /mnt/c/ttbox-local/build-aarch64-t114/ttbox_core_main | md5=4e2d1bc9a1c65fade6e048b31bf9db08 | BuildID=d69c7b15c467ab014a52434db39ce3195aaab883 | 2026-09-19T07:32:40Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=45870f6b91a74364dca5825d7678e5524a08c3c7 md5=4e2d1bc9a1c65fade6e048b31bf9db08 sha256=9343b6e308a8137277456ba66111e444119225b5b21c17a44db196fc84bb1875 buildid=d69c7b15c467ab014a52434db39ce3195aaab883 vector_hash=0091a7df2bbf4d427e34bfd5594ff5ca56ca1398c05beb260d1db37c06cb63eb -->
