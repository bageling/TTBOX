...
| 字段 | 值 |
|---|---|
| `commit` | `6eef4aeb4a7bb798fbd2f7303bfc3d96777428b5` |
...
| `build_time_utc` | 2026-09-18T02:10:13Z |
...
| `md5` | `cd468684aed0c75b1155d1171bc35500` |
| `sha256` | `89ee0758bba3c38a417b6c11d6cc047fd8a837acec15fb599d77aba51627f201` |
| `size` | 1051520 B |
| `buildid` | `e5d91b354e4798ddb60071614430f5ad52c1b547` |
...
| `repro_verify` | 同源 + 同配置向量、不同构建目录 ⇒ 逐字节相同 ✅（候选 B 层；md5 cd468684aed0c75b1155d1171bc35500） |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（b191b5e… → 6eef4ae…） ⇒ 本次 md5=cd468684aed0c75b1155d1171bc35500 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
6eef4aeb4a7bb798fbd2f7303bfc3d96777428b5 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /mnt/c/Users/Administrator/WorkBuddy/2026-09-15-15-04-22/sysroot-aarch64 | /mnt/c/Users/Administrator/Desktop/TTBOX-Module-Edition-main/build-aarch64-t114/ttbox_core_main | md5=cd468684aed0c75b1155d1171bc35500 | BuildID=e5d91b354e4798ddb60071614430f5ad52c1b547 | 2026-09-18T02:10:13Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=6eef4aeb4a7bb798fbd2f7303bfc3d96777428b5 md5=cd468684aed0c75b1155d1171bc35500 sha256=89ee0758bba3c38a417b6c11d6cc047fd8a837acec15fb599d77aba51627f201 buildid=e5d91b354e4798ddb60071614430f5ad52c1b547 vector_hash=0505ccefc7315ac4df2f59b9c1c4f8b29a7127f9f469f8ddcafea29a9d016994 -->
