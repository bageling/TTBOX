...
| 字段 | 值 |
|---|---|
| `commit` | `e0474b1679d78a8e3d0f98b78b3939b95fee7afe` |
...
| `build_time_utc` | 2026-09-18T14:33:54Z |
...
| `md5` | `c9bf7678ea00d94554ad21b52dc9fccb` |
| `sha256` | `af2423d193168defe8e6dfe9a314d71f237b9010a0dac38452d0babc124d5f67` |
| `size` | 1059760 B |
| `buildid` | `a45f00eabe8a4ed4a42ae9654f99b88dad1ed9ac` |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（5b2b4b3… → e0474b1…） ⇒ 本次 md5=c9bf7678ea00d94554ad21b52dc9fccb 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
e0474b1679d78a8e3d0f98b78b3939b95fee7afe | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /mnt/c/Users/Administrator/WorkBuddy/2026-09-15-15-04-22/sysroot-aarch64 | /mnt/c/ttbox-local/build-aarch64-t114/ttbox_core_main | md5=c9bf7678ea00d94554ad21b52dc9fccb | BuildID=a45f00eabe8a4ed4a42ae9654f99b88dad1ed9ac | 2026-09-18T14:33:54Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=e0474b1679d78a8e3d0f98b78b3939b95fee7afe md5=c9bf7678ea00d94554ad21b52dc9fccb sha256=af2423d193168defe8e6dfe9a314d71f237b9010a0dac38452d0babc124d5f67 buildid=a45f00eabe8a4ed4a42ae9654f99b88dad1ed9ac vector_hash=0091a7df2bbf4d427e34bfd5594ff5ca56ca1398c05beb260d1db37c06cb63eb -->
