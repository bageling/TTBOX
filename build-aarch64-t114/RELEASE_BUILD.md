...
| 字段 | 值 |
|---|---|
| `commit` | `5b2b4b38ec0710ae8abd512b924653832f78c95e` |
...
| `build_time_utc` | 2026-09-18T08:41:15Z |
...
| `notes` | 上次留档对照：配置向量已变（vector_hash 0505ccef… → 0091a7df…）⇒ 与上次产物**不同源、不可比**；另：源码 commit 已变（6eef4ae… → 5b2b4b3…）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
5b2b4b38ec0710ae8abd512b924653832f78c95e | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /mnt/c/Users/Administrator/WorkBuddy/2026-09-15-15-04-22/sysroot-aarch64 | /mnt/c/ttbox-local/build-aarch64-t114/ttbox_core_main | md5=cd468684aed0c75b1155d1171bc35500 | BuildID=e5d91b354e4798ddb60071614430f5ad52c1b547 | 2026-09-18T08:41:15Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=5b2b4b38ec0710ae8abd512b924653832f78c95e md5=cd468684aed0c75b1155d1171bc35500 sha256=89ee0758bba3c38a417b6c11d6cc047fd8a837acec15fb599d77aba51627f201 buildid=e5d91b354e4798ddb60071614430f5ad52c1b547 vector_hash=0091a7df2bbf4d427e34bfd5594ff5ca56ca1398c05beb260d1db37c06cb63eb -->
