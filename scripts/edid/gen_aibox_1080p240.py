#!/usr/bin/env python3
"""生成 AIBox Test 1080p240 EDID（专用于 RK3588 HDMI RX 测试，非真实显示器）。
...
产品名 'AIBox1080p240'（13 字符上限，不冒充真实显示器）。

用法：python3 gen_aibox_1080p240.py <out.bin>
"""
import sys
...
def main(out_path):
    ...
    # 90-107 DTD3: Monitor Name 'AIBox1080p240'
    n = [0] * 18
    n[0:5] = [0x00, 0x00, 0x00, 0xFC, 0x00]
    name = b'AIBox1080p240'       # 13 字节
