...
EDID_PROFILES: tuple[EdidProfile, ...] = (
    ...
    EdidProfile(
        ...
        "开机安全 + 240",
        "1080p60compat",
        "开机首选低刷兼容，完整提供 1080p240compat 高刷模式（581.568MHz，CVT-RB 余量足）。",
        False,
        True,
        ("1080p120compat", "1080p240compat", "1440p60"),
    ),
    EdidProfile(
        "boot-safe-full",
        "开机安全 + 全模式",
        "1080p60compat",
        "开机首选低刷兼容，完整声明 1080p 全系列 + 1440p 系列高刷（含 1080p240compat）。",
        False,
        True,
        ("1080p120", "1080p144", "1080p240compat", "1440p60", "1440p120", "1440p144", "2160p60"),
    ),
    EdidProfile(
        "rk3588-full",
        "RK3588 全能力",
        "1440p144",
        "RK3588 hdmirx 全能力声明：1440p144 首选 + 1080p 全系列 + 1440p 系列 + 2160p60。",
        False,
        True,
        ("1080p60", "1080p90", "1080p120", "1080p144", "1080p240", "1440p60", "1440p120", "2160p60"),
    ),
    EdidProfile(
        "2k144",
        "2K144 首选（对齐 239 已验证结构）",
        "1440p144",
        "主 DTD=2560x1440@144（SCDC+Scrambling），CTA 仅 1080p60compat 兜底，不声明 SVD——与 239 已验证可锁定的 EDID 结构一致。",
        False,
        True,
        ("1080p60compat",),
    ),
    EdidProfile(
        ...
        "1080p240 单模式",
        "1080p240",
        "单模式 EDID，只声明 1920x1080@240（标准 594MHz）。",
        False,
        True,
    ),
    EdidProfile(
        "single-1080p240-compat",
        "1080p240 兼容单模式",
        "1080p240compat",
        "单模式 EDID，只声明 1920x1080@240（兼容 581.568MHz，余量更足）。",
        False,
        True,
    ),
    EdidProfile(
