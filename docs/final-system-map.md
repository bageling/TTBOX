...
> ★ **本文件是 2026-08-30 时点快照**：文中**所有计数**（含图中 `CTest 11/11`）均为该时点**历史值**，**非现况**；现况以最新测试报告 / `ctest -N`（Linux host）为准（计数锚定，见 `ttbox-vs-yu-program/m1-acceptance-checklist.md` §0 规则 5）。
