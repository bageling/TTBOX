...
| 字段 | 值 |
|---|---|
| `commit` | `b41b55f3a683e4cd7af5f33786d08337f64f411b` |
...
| `build_time_utc` | 2026-09-24T04:35:11Z |
...
| `md5` | `a299f911a1e70f051654ce14dcf1f882` |
| `sha256` | `116e024802613e64c3ad5d546454155966f1b93a13096d1b40c71d007e834fcd` |
| `size` | 1217976 B |
| `buildid` | `f98fbe46e334e10148f6b4aa23dd1bffe2d093aa` |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（e111020… → b41b55f…） ⇒ 本次 md5=a299f911a1e70f051654ce14dcf1f882 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
b41b55f3a683e4cd7af5f33786d08337f64f411b | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /root/sysroot | /mnt/c/ttbox-local/build-aarch64-t148/ttbox_core_main | md5=a299f911a1e70f051654ce14dcf1f882 | BuildID=f98fbe46e334e10148f6b4aa23dd1bffe2d093aa | 2026-09-24T04:35:11Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=b41b55f3a683e4cd7af5f33786d08337f64f411b md5=a299f911a1e70f051654ce14dcf1f882 sha256=116e024802613e64c3ad5d546454155966f1b93a13096d1b40c71d007e834fcd buildid=f98fbe46e334e10148f6b4aa23dd1bffe2d093aa vector_hash=7e238b5b4c2677fa141a49362904c8112b6a3dd7fbe4b88923fb5e73d6723539 -->
