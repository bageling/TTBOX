...
| 字段 | 值 |
|---|---|
| `commit` | `f716b1dab96c643943a4cb6c5f54c8cfbce21669` |
...
| `build_time_utc` | 2026-09-24T11:44:06Z |
...
| `md5` | `c16037ce1f8435714bd58485ac2b843d` |
| `sha256` | `ee3835e70239edd405b6fdc5717908fbd994801885a5d64b8cb11adcd47819db` |
| `size` | 1235480 B |
| `buildid` | `83788bc15668d275d4e6a8451c7701af83611937` |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（0c43c0b… → f716b1d…） ⇒ 本次 md5=c16037ce1f8435714bd58485ac2b843d 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
f716b1dab96c643943a4cb6c5f54c8cfbce21669 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /root/sysroot | /mnt/c/ttbox-local/build-aarch64-t148/ttbox_core_main | md5=c16037ce1f8435714bd58485ac2b843d | BuildID=83788bc15668d275d4e6a8451c7701af83611937 | 2026-09-24T11:44:06Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=f716b1dab96c643943a4cb6c5f54c8cfbce21669 md5=c16037ce1f8435714bd58485ac2b843d sha256=ee3835e70239edd405b6fdc5717908fbd994801885a5d64b8cb11adcd47819db buildid=83788bc15668d275d4e6a8451c7701af83611937 vector_hash=7e238b5b4c2677fa141a49362904c8112b6a3dd7fbe4b88923fb5e73d6723539 -->
