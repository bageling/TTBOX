...
| 字段 | 值 |
|---|---|
| `commit` | `d697eadaa833bc3b2add00c4c9328ee86ae76e60` |
...
| `build_time_utc` | 2026-09-24T06:00:50Z |
...
| `md5` | `f280cc9619bc4fa45ac5d0ebc15a77b5` |
| `sha256` | `37bbd89f483fa8a3f56c983ff73cc1a5661c2d39f914acc81496bc045c530678` |
| `size` | 1217976 B |
| `buildid` | `b30bc172539e61e442c7410884b030f97d22917b` |
...
| `usbproxy` | sha256 `27d44044eb2098377f9476f2417a9155929343d4e8c5e324e5e4e6cf8892e774`（= `.sha256` 声明值 ✅）；旧目录字面量=0 ✅；重建：重建成功 + sha256 **逐位一致** ✅（理想达成；27d44044eb2098377f9476f2417a9155929343d4e8c5e324e5e4e6cf8892e774） |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（b41b55f… → d697ead…） ⇒ 本次 md5=f280cc9619bc4fa45ac5d0ebc15a77b5 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
d697eadaa833bc3b2add00c4c9328ee86ae76e60 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /root/sysroot | /mnt/c/ttbox-local/build-aarch64-t148/ttbox_core_main | md5=f280cc9619bc4fa45ac5d0ebc15a77b5 | BuildID=b30bc172539e61e442c7410884b030f97d22917b | 2026-09-24T06:00:50Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=d697eadaa833bc3b2add00c4c9328ee86ae76e60 md5=f280cc9619bc4fa45ac5d0ebc15a77b5 sha256=37bbd89f483fa8a3f56c983ff73cc1a5661c2d39f914acc81496bc045c530678 buildid=b30bc172539e61e442c7410884b030f97d22917b vector_hash=7e238b5b4c2677fa141a49362904c8112b6a3dd7fbe4b88923fb5e73d6723539 -->
