...
| 字段 | 值 |
|---|---|
| `commit` | `7b2d2e953da4a58340f1cdbaf3129075997a1c92` |
...
| `build_time_utc` | 2026-09-26T11:57:39Z |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（9fc62ef… → 7b2d2e9…） ⇒ 本次 md5=108f41a43732866b4c5d32341c6d4a7a 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
7b2d2e953da4a58340f1cdbaf3129075997a1c92 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /root/sysroot | /mnt/c/ttbox-local/build-aarch64-t148/ttbox_core_main | md5=108f41a43732866b4c5d32341c6d4a7a | BuildID=59ed4afe2da5659829f0100828d517ab041e87f7 | 2026-09-26T11:57:39Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=7b2d2e953da4a58340f1cdbaf3129075997a1c92 md5=108f41a43732866b4c5d32341c6d4a7a sha256=27ec7bfddad3b39475ba09e7861db30a3d9215b74c468ebc25ced675e56008c3 buildid=59ed4afe2da5659829f0100828d517ab041e87f7 vector_hash=7e238b5b4c2677fa141a49362904c8112b6a3dd7fbe4b88923fb5e73d6723539 -->
