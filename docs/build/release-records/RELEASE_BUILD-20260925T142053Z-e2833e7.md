...
| 字段 | 值 |
|---|---|
| `commit` | `e2833e71b03fbdff6082c02e49450502293408c8` |
...
| `build_time_utc` | 2026-09-25T14:20:53Z |
...
| `md5` | `79ea2fe02631adfb6e4309d636b98cc7` |
| `sha256` | `abe8a66b08c65034838b5f25afe26b8ebbd295b33f6b0e2c8e24e757293870cc` |
| `size` | 1235480 B |
| `buildid` | `773800e07e85302d74c8a26759a0adae3d899a06` |
...
| `notes` | 上次留档对照：配置向量相同，但源码 commit 已变（f716b1d… → e2833e7…） ⇒ 本次 md5=79ea2fe02631adfb6e4309d636b98cc7 与上次的差异属**预期改变**（非非确定性）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
e2833e71b03fbdff6082c02e49450502293408c8 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /root/sysroot | /mnt/c/ttbox-local/build-aarch64-t148/ttbox_core_main | md5=79ea2fe02631adfb6e4309d636b98cc7 | BuildID=773800e07e85302d74c8a26759a0adae3d899a06 | 2026-09-25T14:20:53Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=e2833e71b03fbdff6082c02e49450502293408c8 md5=79ea2fe02631adfb6e4309d636b98cc7 sha256=abe8a66b08c65034838b5f25afe26b8ebbd295b33f6b0e2c8e24e757293870cc buildid=773800e07e85302d74c8a26759a0adae3d899a06 vector_hash=7e238b5b4c2677fa141a49362904c8112b6a3dd7fbe4b88923fb5e73d6723539 -->
