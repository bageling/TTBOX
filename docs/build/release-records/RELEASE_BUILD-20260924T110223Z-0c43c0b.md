...
| 字段 | 值 |
|---|---|
| `commit` | `0c43c0b3cea6aec2f6f9df6729ad94b8e48185c1` |
...
| `build_time_utc` | 2026-09-24T11:02:23Z |
...
| `md5` | `8ad206b005b4fc46cebd26ffbb8b4986` |
| `sha256` | `37ad8fff9574060050b35e5a7a4dabf7f23fece4c72695baf05bfad6c529caa3` |
| `size` | 1235480 B |
| `buildid` | `665c6a99ec65c02360bedf3054cf79354c6877a2` |
...
| `notes` | 上次留档对照：配置向量已变（vector_hash 18409151… → 7e238b5b…）⇒ 与上次产物**不同源、不可比**；另：源码 commit 已变（877eb5a… → 0c43c0b…）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
0c43c0b3cea6aec2f6f9df6729ad94b8e48185c1 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /root/sysroot | /mnt/c/ttbox-local/build-aarch64-t148/ttbox_core_main | md5=8ad206b005b4fc46cebd26ffbb8b4986 | BuildID=665c6a99ec65c02360bedf3054cf79354c6877a2 | 2026-09-24T11:02:23Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=0c43c0b3cea6aec2f6f9df6729ad94b8e48185c1 md5=8ad206b005b4fc46cebd26ffbb8b4986 sha256=37ad8fff9574060050b35e5a7a4dabf7f23fece4c72695baf05bfad6c529caa3 buildid=665c6a99ec65c02360bedf3054cf79354c6877a2 vector_hash=7e238b5b4c2677fa141a49362904c8112b6a3dd7fbe4b88923fb5e73d6723539 -->
