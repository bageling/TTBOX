...
| 字段 | 值 |
|---|---|
| `commit` | `607fd5348442a5417b2a234f62781c0ecf7dd205` |
...
| `build_time_utc` | 2026-09-24T09:51:21Z |
...
| `md5` | `db45a0ac63c8d63d5fe2e18dbee53b24` |
| `sha256` | `153cce351e828e8eb0a8855cf6aedbd6b382713eec10c6c4f38a444adeb60c97` |
| `size` | 1217808 B |
| `buildid` | `d9cec6a3b32339e29f931a8f3c44ce218679b85d` |
...
| `notes` | 上次留档对照：配置向量已变（vector_hash 7e238b5b… → 18409151…）⇒ 与上次产物**不同源、不可比**；另：源码 commit 已变（18f043d… → 607fd53…）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
607fd5348442a5417b2a234f62781c0ecf7dd205 | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /root/sysroot | /mnt/g/WORKBUDDY工作区/TTBOX-最终源码-2026-09-18/build-aarch64-t148/ttbox_core_main | md5=db45a0ac63c8d63d5fe2e18dbee53b24 | BuildID=d9cec6a3b32339e29f931a8f3c44ce218679b85d | 2026-09-24T09:51:21Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=607fd5348442a5417b2a234f62781c0ecf7dd205 md5=db45a0ac63c8d63d5fe2e18dbee53b24 sha256=153cce351e828e8eb0a8855cf6aedbd6b382713eec10c6c4f38a444adeb60c97 buildid=d9cec6a3b32339e29f931a8f3c44ce218679b85d vector_hash=18409151d8caebe709db20ccd46d2cf8b01eadd8d834d4e0092157fa0d73f95d -->
