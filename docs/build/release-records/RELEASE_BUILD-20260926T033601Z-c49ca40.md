...
| 字段 | 值 |
|---|---|
| `commit` | `c49ca4041f8d23966da16760c00d7fd0f8d34f9a` |
...
| `build_time_utc` | 2026-09-26T03:36:01Z |
...
| `md5` | `d58c3e2ff54bb41bf6d5a2a8b4268336` |
| `sha256` | `f662a1e0ebb3097dfeb43b0369b3f71871245175ee0f8336ceb131f9cbe911f6` |
| `size` | 1248864 B |
| `buildid` | `16803ce7765f3095970a76233f55959d1a62b0ef` |
...
| `notes` | 上次留档对照：配置向量已变（vector_hash 7e238b5b… → 18409151…）⇒ 与上次产物**不同源、不可比**；另：源码 commit 已变（93d6a41… → c49ca40…）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
c49ca4041f8d23966da16760c00d7fd0f8d34f9a | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /root/sysroot | /mnt/g/WORKBUDDY工作区/TTBOX-最终源码-2026-09-18/build-aarch64-t148/ttbox_core_main | md5=d58c3e2ff54bb41bf6d5a2a8b4268336 | BuildID=16803ce7765f3095970a76233f55959d1a62b0ef | 2026-09-26T03:36:01Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=c49ca4041f8d23966da16760c00d7fd0f8d34f9a md5=d58c3e2ff54bb41bf6d5a2a8b4268336 sha256=f662a1e0ebb3097dfeb43b0369b3f71871245175ee0f8336ceb131f9cbe911f6 buildid=16803ce7765f3095970a76233f55959d1a62b0ef vector_hash=18409151d8caebe709db20ccd46d2cf8b01eadd8d834d4e0092157fa0d73f95d -->
