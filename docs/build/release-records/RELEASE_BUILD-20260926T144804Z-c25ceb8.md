...
| 字段 | 值 |
|---|---|
| `commit` | `c25ceb887218f7cae45a2d05c40b2cb6c2fca47e` |
...
| `build_time_utc` | 2026-09-26T14:48:04Z |
...
| `md5` | `c0859206ffd3e33dce94fa194984ae23` |
| `sha256` | `650fc870ed68ccc78a37383b6c4325bce4a4c95b8d398e07836de61579296916` |
| `size` | 1253336 B |
| `buildid` | `c1322bc8618b5717796bcb4c15f0b3d87673dbc5` |
...
| `notes` | 上次留档对照：配置向量已变（vector_hash 65802e9d… → 18409151…）⇒ 与上次产物**不同源、不可比**；另：源码 commit 已变（7fd63d5… → c25ceb8…）；A4①=0（期望 0）/ A4②=1（期望 >=1）；CROSS_AARCH64=ON |

## §5 单行记录（供仓库外备份共用）

```
c25ceb887218f7cae45a2d05c40b2cb6c2fca47e | /usr/bin/aarch64-linux-gnu-g++ (GCC 11.4.0) — aarch64-linux-gnu-g++ (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0 | /root/sysroot | /mnt/g/WORKBUDDY工作区/TTBOX-最终源码-2026-09-18/build-aarch64-t148/ttbox_core_main | md5=c0859206ffd3e33dce94fa194984ae23 | BuildID=c1322bc8618b5717796bcb4c15f0b3d87673dbc5 | 2026-09-26T14:48:04Z | Ubuntu 22.04.5 LTS @ PC-20260805NLLL | third=0/ip=0/cred=0
```

<!-- RELEASE_BUILD_RECORD: commit=c25ceb887218f7cae45a2d05c40b2cb6c2fca47e md5=c0859206ffd3e33dce94fa194984ae23 sha256=650fc870ed68ccc78a37383b6c4325bce4a4c95b8d398e07836de61579296916 buildid=c1322bc8618b5717796bcb4c15f0b3d87673dbc5 vector_hash=18409151d8caebe709db20ccd46d2cf8b01eadd8d834d4e0092157fa0d73f95d -->
