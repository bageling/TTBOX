...
class UnitTests(unittest.TestCase):
 def test_core_unit_matches_boundary(self):
  self.assertIn('ExecStart=/opt/ttbox/core/current/ttbox-core',CORE_UNIT); self.assertIn('Restart=always',CORE_UNIT); self.assertIn('TTBOX_CONFIG_PATH=/opt/ttbox/config/current',CORE_UNIT)
